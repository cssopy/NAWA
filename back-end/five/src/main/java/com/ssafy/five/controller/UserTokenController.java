...
public class UserTokenController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "(BAD_REQUEST) 해당 유저의 토큰이 아님"),
            @ApiResponse(responseCode = "403", description = "(FORBIDDEN) refreshToken 만료")
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "(BAD_REQUEST) 정지된 유저"),
