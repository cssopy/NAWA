      ...
      <View style={{ backgroundColor:'lightgrey', width:constants.width, height:constants.height }}>
        <View style={styles.topBox}>
          ...
          <View style={styles.infoBox}>
            ...
            <Ionicons onPress={() => {navigation.push('Mate3')}} name={'md-caret-forward-circle'} size={30} color={'black'} />
          </View>

          <Progress.Bar style={{marginHorizontal:3}} progress ={0.6} width={constants.width - 6} height={6} unfilledColor={'lightgrey'} />
