...
CREATE TABLE `location_list` (
  ...
  `locAddres` varchar(255) NOT NULL,
  `locLat` double NOT NULL,
  `locLng` double NOT NULL,
  `userId` varchar(20) DEFAULT NULL,
  `locName` varchar(255) NOT NULL,
  PRIMARY KEY (`locId`),
  KEY `FKhksugyre4te3c5nrwk0cwm67t` (`userId`),
  CONSTRAINT `FKhksugyre4te3c5nrwk0cwm67t` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE CASCADE
